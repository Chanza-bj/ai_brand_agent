...
config :ai_brand_agent, AiBrandAgentWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "A7V/M2Hhou/PiMisvNd0n99Wvtl6rFaDDMoTHobV/NapEsPNv43VucRTh07hUDlS",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:ai_brand_agent, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:ai_brand_agent, ~w(--watch)]}
  ]
...
config :ai_brand_agent, AiBrandAgentWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/ai_brand_agent_web/router\.ex$",
      ~r"lib/ai_brand_agent_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :ai_brand_agent, dev_routes: true
